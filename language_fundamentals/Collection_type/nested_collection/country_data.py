...
total_num_countries = len(countries_data)
print("Total number of countries",total_num_countries)
print("\n")

# total number of Asian countries

total_num_asian_countries = len([di for di in countries_data if di.get("region") == "Asia"])
print("Total number of Asian coutries:",total_num_asian_countries)

# country with highest population

max_population = max([di.get("population") for di in countries_data])
highest_population = {di.get("country_name"):max_population for di in countries_data if di.get("population")== max_population}
print("Country with highest population:",highest_population)

# or

highest_pop_country_data = max(countries_data,key = lambda c:c.get("population"))
print("Country with highest population:",highest_pop_country_data)

# sort countries wrt  population

country_population_list = sorted([[di.get("population"),di.get("country_name")]for di in countries_data])

print("Sorted countries wrt population:",country_population_list)

# or

sorted_country_data_wrt_popul = sorted(countries_data,key = lambda c:c.get("population"))
print("Sorted countries wrt population:",sorted_country_data_wrt_popul)


# display all unique region

unique_reg = {di.get("region") for di in countries_data}
print("Unique region:",unique_reg)

#independent country names

ind_country_name = [di.get("country_name") for di in countries_data if di.get("is_independent") == True]
print("Independent coutry names:",ind_country_name)